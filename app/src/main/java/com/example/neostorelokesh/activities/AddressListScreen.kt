...
import com.example.neostorelokesh.dataclass.PlaceOrderResponse
import com.example.neostorelokesh.storage.*
...
class AddressListScreen : AppCompatActivity(), Adapter.cartInterface{
...
*/
        ...
        btnPlaceOrder.setOnClickListener(){
            val intent = Intent(this,MyOrdersScreen::class.java)
            startActivityForResult(intent, 101)
            placeOrder()
        }
