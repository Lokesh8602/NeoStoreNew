...
import com.example.neostorelokesh.dataclass.DefaultResponse
import com.example.neostorelokesh.dataclass.InvalidData
            ...
            override fun onResponse(
                ...
                if(response.code() == 500 || response.code()==404 || response.code() == 422){
                    ...
                    try {
                        ...
                        Toast.makeText(this@Register, "${error.user_msg}", Toast.LENGTH_SHORT).show()
                    ...
                    Toast.makeText(this@Register, "$responseData", Toast.LENGTH_SHORT).show()
